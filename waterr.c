...
//1. fixed fee
if(CustomerType == 1)
fixedfee = 10*quarters;
else
fixedfee = 50*quarters;

if(CustomerType == 2)
{
band = 5;
}
elseif(QWaterConsumption>=1 && QWaterConsumption<=5)
{
	band = 1;
}
elseif(QWaterConsumption>=6 && QWaterConsumption<=12)
{
	band = 2;
}
elseif(QWaterConsumption>=13 && QWaterConsumption<=25)
{
	band = 3;
}
elseif(QWaterConsumption>=26 && QWaterConsumption<=60)
{
	band = 4;
}
elseif(QWaterConsumption>40)
{
	band = 5;
}
else
...
if(CustomerType ==2)
{
consumption = QWaterConsumption*2.50;
processing = QWaterConsumption*2 + 50*quarters + quarters*91*1.30;
}
else
{
	processing = 0.95*QWaterConsumption*0.25;
	Switch(QWaterConsumption)
	{
		case 1:
		{
			consumption = QWaterConsumption*0.20 + quarters*91*0.10 + 10*quarters;

		}
		break;
		case 2:
		{
			consumption = QWaterConsumption*0.35+ quarters*91*0.10 + 10*quarters;
		}
		break;
		case 3:
		{
			consumption = QWaterConsumption*0.50+ quarters*91*0.10 + 10*quarters;
		}
		break;
		case 4:
		{
			consumption = QWaterConsumption*0.75+ quarters*91*0.10 + 10*quarters;
		}
		break;
		case 5:
		{
			consumption = QWaterConsumption*2.50+ quarters*91*0.10 + 10*quarters;
		}
	}
}
...
bill = fixedfee + consumption + processing;
//standing charges added within consumption

//adding vat for commercial customers
if(CustomerType == 2)
QVat = 0.2*bill;
